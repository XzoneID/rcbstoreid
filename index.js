...
try {
let { ownerNumber, botName, contactOwner } = setting
const { type, quotedMsg, mentioned, now, fromMe, isBaileys } = msg
if (msg.isBaileys) return
const jam = moment.tz('asia/jakarta').format('HH:mm')
const tanggal = moment().tz("Asia/Jakarta").format("ddd,ll")
...
const isOwner = [`${setting.ownerNumber}`,"6285808654304@s.whatsapp.net"].includes(sender) ? true : false
const isContact = [`${setting.contactOwner}`,"6285878654304"]
...
const fkontak = { key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { 'contactMessage': { 'displayName': `Rcb-Bot\n`, 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;RcbBot,;;;\nFN:${pushname},\nitem1.TEL;waid=${sender.split('@')[0]}:${sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, 'jpegThumbnail': { url: 'https://telegra.ph/file/3c485ff201d9337be14ef.jpg' }}}}
...
┏━━━『 𝘿𝘼𝙏𝘼 𝘽𝙊𝙏 』━━━━━◧
┃
┣» ᴄʀᴇᴀᴛᴏʀ : @${setting.contactOwner}
┣» ʙᴏᴛ ɴᴀᴍᴇ : ${setting.botName}
┣» ᴏᴡɴᴇʀ ɴᴀᴍᴇ : ${setting.ownerName} 
┣» ʀᴜɴɴɪɴɢ : ${runtime(process.uptime())}
┃
┗━━━━━━━━━━━━━━━━━━◧
┏━━━━『 𝙇𝙞𝙨𝙩 𝙈𝙚𝙣𝙪 』━━━━◧
┃
...
┗━━━━━━━━━━━━━━━━━━◧`
let btn_menu = [
{buttonId: '#donate', buttonText: {displayText: '️DONASI'}, type: 1},
...
const strip_ny = more.repeat(4001)
var footer_nya =`Creator by - ${setting.ownerName}`
let tampilan_nya = `Hallo Kak..👋@${sender.split("@")[0]}
Saya *RCB-BOT* sistem Rancangan
Dari *AnsCmlfdhy*

*Untuk Donasi Silakan Klik Tombol*
_Dibawah ini!_
...
break
case 'owner':{
var run = `Hay kk : @${setting.contactOwner}`
...
- *Dana :* 085808654304
- *Gopay :*  085808654304
- *ShopeePay :* 085808654304

OK, thanks udah order di *Rcb Store*
`
ramz.sendMessage(from, { image: fs.readFileSync(`./gambar/qris.jpg`),
 caption: tekssss, 
footer: `${setting.ownerName} © 2022`},
...
let btn_menu = [
{buttonId: `${prefix}p`, buttonText: { displayText: 'BUY🛒' }, type: 1 },
]
ramz.sendMessage(from,
{text: teq,
buttons: btn_menu},
...
if (!isOwner && !fromMe) return reply(mess.OnlyOwner)
if (!isOwner && !fromMe) return reply('Ngapain..?')
let tek = (`「 *TRANSAKSI BERHASIL* 」\n\n\`\`\`📆 TANGGAL : ${tanggal}\n⌚ JAM     : ${jam}\n✨ STATUS  : Berhasil\`\`\`\n\nTerimakasih Telah order di *RCB STORE*\nNext Order ya🙏`)
let btn_menu = [
...
var listMsg = {
text: `*Halo Kak* _@${sender.split("@")[0]}_ \n*${ucapanWaktu}!* \n\n*Silakan Pilih Produknya*`,
...
if ((budy) && ["tes", "Tes", "TES", "Test", "test", "ping", "Ping", "runtime"].includes(budy) && !isCmd) {
...
*Type:* ${err}`
ramz.sendMessage(setting.contactOwner, {text:errny, mentions:[sender]})
}}